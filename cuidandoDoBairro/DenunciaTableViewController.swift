...
class DenunciaTableViewController: UITableViewController {
    var fetchedResultController: NSFetchedResultsController<Denuncia>!
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?){
            ...
            let indexPath = tableView.indexPathForSelectedRow {
                denunciaViewController.denuncia = fetchedResultController.object(at: indexPath)
        }
    }
    func loadDenuncias(){
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let denuncia = fetchedResultController.object(at: indexPath)
